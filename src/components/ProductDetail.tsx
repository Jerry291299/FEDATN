            ...
            <div className='container mx-auto w-[1400px] pt-[100px]'>
                {products && (
                    <div className='container mx-auto w-[1300px] flex'>
                        <div className=''>
                            <img className='mb-[20px] w-[150px]' src={products.img} alt={products.name} />
                            <img className='mb-[20px] w-[150px]' src={products.img} alt={products.name} />
                            <img className='mt-[10px] w-[150px]' src={products.img} alt={products.name} />
                            <img className='mt-[10px] w-[150px]' src={products.img} alt={products.name} />
                        </div>
                        <div className='ml-[40px]'>
                            <img className='w-[650px] object-cover' src={products.img} alt={products.name} />
                        </div>
                        <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
                            <h1 className="text-xl font-bold text-black-800">{products.name}</h1>
                            {/* <p className="font-bold text-gray-500">Danh mục: {products?.category}</p> */}
                            <div className="my-4">
                                <div className="flex items-baseline">
                                    <span className="text-2xl font-semibold text-black-600">{products.price}₫</span>
