...
export const ProductDetail = () => {
    return (
      ...
      <p className="text-sm text-gray-500">SKU: (ĐANG CẬP NHẬT...)</p>
      
      <div className="my-4">
        <div className="flex items-baseline">
          <span className="text-2xl font-semibold text-black-600">950.000₫</span>
         <p className="m-[15px] text-[15px]"> Gía thị trường:<span className="text-gray-400 line-through ml-2">1.000.000₫</span></p>
        </div>
        <p className="font-bold text-gray-600">Tiết kiệm: <span className="text-red-600">50.000₫</span></p>
        <p className="font-bold text-gray-500 mt-2">Tình trạng: <span className="font-semibold text-red-500">Hết hàng</span></p>
      </div>
      ...
      <div className="flex items-center my-4">
        ...
        <p className='w-12 text-center border border-gray-300'>1</p>
        <button 
