...
<div className="grid grid-cols-2 gap-4 border-t-2 border-black pt-[15px]">
  <div className="">
    ...
    <p className="font-bold text-[15px] text-center">Gợi ý nội thất cho không gian thư giãn mùa thu</p>
  ...
  <div className="">
    ...
    <p className="font-bold text-[15px] text-center">Phòng khách tối giản, hiện đại cho giới trẻ</p>
    <a href="#" className="text-[17px]">Phòng khách tối giản mang đến một không gian thanh lịch và gọn gàng...</a>
  </div>
</div>
...
<div className="grid grid-cols-2 gap-4  pt-[15px] ">
  <div className="">
    ...
    Triển lãm VIBE 2024
      ...
      <a href="#" className="text-[17px]"> vinh dự góp mặt tại triển lãm VIBE 2024,giới thiệu loạt sản phẩm và bộ sưu tập[..]</a>
  </div>
  <div className="">
      <div className="">
