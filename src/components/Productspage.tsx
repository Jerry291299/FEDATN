...
const Productspage = (props: Props) => {
    ...
    const filterProduct = products.filter(
        (product) =>
            ...
            product.status &&
            (filterMaterial === "" ||
                product.material?.name === filterMaterial) && // Material filter
            product.price >= filterPrice[0] &&
            product.price <= filterPrice[1] // Price filter
    );
            ...
            <div className="container mx-auto py-10 px-4 flex">
                <div className="w-1/4 pr-4 flex flex-col text-left">
                    ...
                    >
                        ...
                        {Array.from(
                            new Set(products.map((p) => p.material?.name))
                        ).map(
                            (material) =>
                                material && (
                    ...
                    {filterProduct.length === 0 ? (
                        <div className="text-center">
                            ...
                            <p className="text-gray-500">
                                Xin lỗi, không có sản phẩm phù hợp với yêu cầu
                                của bạn.
                            </p>
                        </div>
                    ) : (
